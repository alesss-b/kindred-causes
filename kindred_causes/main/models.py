...
class Skill(Base):
    ...
    description = models.CharField(max_length=254, null=False, blank=False, verbose_name="Description", db_comment="A detailed description of the Skill.")
    def __str__(self):
        return self.name
...
class Event(Base):
    ...
    description = models.CharField(max_length=254,null=False, blank=False, verbose_name="Description", db_comment="A detailed description of the Event.")
    location = models.CharField(max_length=254,null=False, blank=False, verbose_name="Location", db_comment="The location of the event.")
