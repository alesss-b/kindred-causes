...
#     name = models.CharField(max_length=32, null=False, blank=False, verbose_name="Name", help_text="The name of the State.")
#     abbreviation = models.CharField(max_length=2, null=False, blank=False, verbose_name="Name", help_text="The abbreviation of the State.")