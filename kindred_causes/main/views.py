...
def account(request: HttpRequest) -> HttpResponse:
    ...
    context = {
        ...
        "address": request.session.get("address", "123 Main St"),
        "address2": request.session.get("address2", "None"),
        "zip_code": request.session.get("zip_code", "11223"),
...
def account_management(request: HttpRequest) -> HttpResponse:
    ...
    if request.method == "POST":
        ...
        request.session["address"] = request.POST.get("address", "123 Main St")
        request.session["address2"] = request.POST.get("address2", "None")
        request.session["zip_code"] = request.POST.get("zip_code", "11223")
